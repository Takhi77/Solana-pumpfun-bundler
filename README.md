...
I am doing with 28 wallets, but there is possibility to increase the number of wallets.
...
It provides methods for creating, buying from 28 wallets, and selling tokens when you want.
...
## 5. Sell tokens at once from 28 wallets using bundle when you want

## 6. Gathering Sol from 28 wallets you bundle buy and sell
